  ...
  return (
    <AuthActionPage description="Enter your work email and we’ll send a secure password-reset link." title="Reset your password">
      <form className="mt-6 space-y-4 text-left">
        <label className="block text-xs font-medium">Work email<input className="mt-2 h-11 w-full rounded-lg border border-[var(--outline-variant)] bg-[var(--surface-container-lowest)] px-3 text-sm outline-none focus:border-[var(--primary)]" placeholder="you@company.com" required type="email" /></label>
