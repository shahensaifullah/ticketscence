      ...
      <div className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8">
        <div className="mx-auto max-w-[1440px] space-y-6">
          <PageHeader
            actions={
              <>
                <Link className="rounded-lg border border-[var(--outline-variant)] px-4 py-2.5 text-xs font-semibold hover:bg-[var(--surface-container-high)]" href="/analytics">
                  View analytics
                </Link>
                <Link className="inline-flex items-center gap-2 rounded-lg bg-[var(--primary-container)] px-4 py-2.5 text-xs font-semibold text-[var(--on-primary-container)] hover:bg-[var(--primary-hover)]" href="/tickets/new">
                  <Plus aria-hidden="true" size={15} /> Create ticket
                </Link>
              </>
            }
            description="Prioritize risk, unblock your team, and resolve the work that matters most."
            eyebrow="Friday, 24 October"
